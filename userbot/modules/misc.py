...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit(
        "[Click Here](https://github.com/febbypratama/kangproject) to see KangProject Repo.\n[Click Here](https://github.com/BianSepang/ProjectBish) to see My Fuckin Friend Repo's Who Guide Me"
    )
